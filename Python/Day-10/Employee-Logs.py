...
class Manager(Employee):
    def __init__(self, name: str, salary: float):
        ...
        with open("Employee_details.csv",mode='a',newline="") as file:
            ...
            writer.writerow([self.name,self.__class__.__name__,self.get_salary(),datetime.datetime.now()])
...
class Department:
    ...
    def hire(self, employee: Employee) -> None:
        ...
        # data=[[employee.name,employee.get_salary(),'hired',datetime.datetime.now()]]
        with open("Employee_logs.csv",mode='a',newline="") as file:
            writer=csv.writer(file)
            writer.writerow([employee.name,employee.__class__.__name__,employee.get_salary(),'Hired',datetime.datetime.now()])
    ...
    def fire(self, employee: Employee) -> None:
        ...
        with open("Employee_logs.csv",mode='a',newline="") as file:
            writer=csv.writer(file)
            writer.writerow([employee.name,employee.__class__.__name__,employee.get_salary(),'Fired',datetime.datetime.now()])
